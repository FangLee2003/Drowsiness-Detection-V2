...
def get_ear(landmarks, landmark_indexs, frame_width, frame_height):
    """
    Calculate Eye Aspect Ratio for one eye.

    Args:
        landmarks: (list) Detected landmarks list
        landmark_indexs: (list) Index positions of the chosen landmarks
    ...
    try:
        ...
        coords_points = []
        for i in landmark_indexs:
            coord = denormalize_coordinates(landmarks[i].x, landmarks[i].y, frame_width, frame_height)
...
class VideoFrameHandler:
    def __init__(self):
        ...
        self.RED = (117, 109, 244)  # BGR
        self.GREEN = (156, 192, 74)  # BGR
